                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> User Id </th><td> {{ $post->user_id }} </td></tr><tr><th> Body </th><td> {!! $post->body !!} </td></tr><tr><th> Created At </th><td> {{ $post->created_at }} </td></tr><tr><th> Updated At </th><td> {{ $post->updated_at }} </td></tr>
                                </tbody>
                            </table>
                        </div>
